    ...
    <header className={headerClass}>
      ...
      <div className="flex min-w-0 items-center space-x-4 leading-5 sm:-mr-6 xl:space-x-6">
        ...
        <a
          ...
          className="bg-mint text-primary-800 hover:text-primary-900 dark:text-primary-300 flex h-11 w-11 shrink-0 items-center justify-center rounded-md font-semibold xl:h-auto xl:w-auto xl:gap-2 xl:bg-transparent xl:text-gray-900 dark:bg-gray-900 xl:dark:bg-transparent xl:dark:text-gray-100"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
            ...
            className="text-primary-800 dark:text-primary-300 h-5 w-5 xl:h-[18px] xl:w-[18px]"
            aria-hidden="true"
          >
